...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(SuperAnnouncer instance, CommandSender sender, String... args);

    protected abstract List<String> onTab(SuperAnnouncer instance, CommandSender sender, String... args);
